...
struct bflb_device_s *ecp_pka;

#define Sec_Eng_PKA_MADD(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_madd(ecp_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
#define Sec_Eng_PKA_MSUB(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_msub(ecp_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
#define Sec_Eng_PKA_MMUL(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_mmul(ecp_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
// #define Sec_Eng_PKA_LCMP()
#define Sec_Eng_PKA_Write_Data(dt, di, data, len, lastop) bflb_pka_write(ecp_pka, di, dt, data, len, lastop)
#define Sec_Eng_PKA_Read_Data(dt, di, data, len) bflb_pka_read(ecp_pka, di, dt, data, len)
#define Sec_Eng_PKA_Move_Data(dt, di, s0t, s0i, lastop) bflb_pka_movdat(ecp_pka, s0i, s0t, di, dt, lastop)
#define Sec_Eng_PKA_MREM(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_mrem(ecp_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_MINV(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_minv(ecp_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_MSQR(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_msqr(ecp_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_CREG(dt, di, size, lastop) bflb_pka_clir(ecp_pka, di, dt, size, lastop)
#define Sec_Eng_PKA_Write_Immediate(dt, di, data, lastop) bflb_pka_slir(ecp_pka, di, dt, data, lastop)
#define Sec_Eng_PKA_LMUL2N(dt, di, s0t, s0i, bitshift, lastop) bflb_pka_lmul2n(ecp_pka, s0i, s0t, di, dt, bitshift, lastop)
#define Sec_Eng_PKA_Reset() ecp_pka = bflb_device_get_by_name(BFLB_NAME_SEC_PKA); bflb_pka_init(ecp_pka)
...
{
    *out = bflb_pka_lcmp(ecp_pka, s0i, s0t, s1i, s1t);
}
