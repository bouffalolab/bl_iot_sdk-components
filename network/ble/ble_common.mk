...
ifeq ($(PRIV_CONFIG_GEN_BLE),m0s1t10)
CONFIG_BUILD_BLE_ROM_CODE := 1
CONFIG_BT_CONN := 1
...
ifeq ($(PRIV_CONFIG_GEN_BLE),bcast_noos)
CONFIG_FREERTOS_DISABLE := 1
CONFIG_BUILD_BLE_ROM_CODE := 1
...
ifeq ($(PRIV_CONFIG_GEN_BLE),m0s1p_simple)
CONFIG_BUILD_BLE_ROM_CODE := 1
CONFIG_BLE_PDS := 1
CONFIG_BT_CONN := 1
CONFIG_BLE_TX_BUFF_DATA := 2
...
CONFIG_DISABLE_BLE_CONTROLLER_TEST_MODE := 0
CONFIG_BLE_HOST_DISABLE:=1
CONFIG_BLE_ADV_TWO_PAYLOAD_IN_ONE_ADV_INTERVAL_WITH_ROME_CODE := 1
CONFIG_EM_SIZE = 8
CONFIG_LONG_RANG := 0
CONFIG_CLK_ACC := 0
CONFIG_LE_PING := 0
...
ifeq ($(CONFIG_BT_A2DP_SINK),1)
CFLAGS += -DCONFIG_BT_A2DP_SINK
endif
endif
...
CONFIG_BLE_USING_DYNAMIC_RAM?=0
CONFIG_BT_MESH?=0
...
ifeq ($(CONFIG_BT_REMOTE_VERSION), 1)
...
ifneq ($(CONFIG_BT_STACK_PTS),1)
CFLAGS += -DCONFIG_BT_ATT_PREPARE_COUNT=$(CONFIG_BT_ATT_PREPARE_COUNT)
endif

ifeq ($(CONFIG_BLE_USING_DYNAMIC_RAM),1)
CFLAGS += -DCONFIG_BLE_USING_DYNAMIC_RAM=$(CONFIG_BLE_USING_DYNAMIC_RAM)
endif
