...
void bugkiller_help(void)
{
    ...
    struct bugkiller_command *start = (struct bugkiller_command*)&__bugkiller_command_start;
    struct bugkiller_command *end = (struct bugkiller_command*)&__bugkiller_command_end;
    while(start < end) {
