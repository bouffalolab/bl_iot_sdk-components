...
ifdef CONFIG_AOS_LOOP_STACK_DEPTH
CPPFLAGS += -DCFG_AOS_LOOP_STACK_DEPTH=$(CONFIG_AOS_LOOP_STACK_DEPTH)
else
CPPFLAGS += -DCFG_AOS_LOOP_STACK_DEPTH=1024
endif

ifdef CONFIG_SYS_AOS_LOOP_TASK_PRIORITY
CPPFLAGS += -DSYS_AOS_LOOP_TASK_PRIORITY=$(CONFIG_SYS_AOS_LOOP_TASK_PRIORITY)
else
CPPFLAGS += -DSYS_AOS_LOOP_TASK_PRIORITY=15
endif
...
ifeq ($(CONFIG_OPENTHREAD_CLI_ENABLE), 1)
CPPFLAGS += -DCFG_OPENTHREAD_CLI_EN
endif
...
CPPFLAGS += -DCONFIG_USE_UART_1_FOR_DEBUG
endif
