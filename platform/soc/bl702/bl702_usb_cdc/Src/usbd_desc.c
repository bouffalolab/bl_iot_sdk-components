...
//#define USB_ST_PID_VID
#define USE_BCDUSB_2P00

#ifdef USB_ST_PID_VID
/*****************************************************************************/
...
#define USBD_LANGID_STRING                     1033
#define USBD_MANUFACTURER_STRING             "BLIOT"
#define USBD_PID_FS                         0xFFFF
#define USBD_PRODUCT_STRING_FS                 "CDC Virtual ComPort"
...
#else
// mzhu optimization: max(strlen(string descriptor)) * 2 + 2
__ALIGN_BEGIN uint8_t USBD_StrDesc[40] __ALIGN_END;
#endif
