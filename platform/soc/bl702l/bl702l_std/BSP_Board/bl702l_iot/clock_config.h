...
#define BSP_ROOT_CLOCK_SOURCE      GLB_SYS_CLK_DLL128M
...
#define BSP_TIMER0_CLOCK_SOURCE ROOT_CLOCK_SOURCE_XCLK
#define BSP_TIMER0_CLOCK_DIV    0
#endif
#if defined(BSP_USING_TIMER1)
#define BSP_TIMER1_CLOCK_SOURCE ROOT_CLOCK_SOURCE_XCLK
#define BSP_TIMER1_CLOCK_DIV    0
#endif
#if defined(BSP_USING_WDT)
#define BSP_WDT_CLOCK_SOURCE ROOT_CLOCK_SOURCE_XCLK
#define BSP_WDT_CLOCK_DIV    0
#endif
#if defined(BSP_USING_ADC0)
#define BSP_ADC_CLOCK_SOURCE ROOT_CLOCK_SOURCE_XCLK
#define BSP_ADC_CLOCK_DIV    1
#endif
