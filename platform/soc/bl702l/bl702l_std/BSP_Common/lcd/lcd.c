...
int lcd_init(void)
{
    ...
    res = ili9488_dbi_init();
#elif defined(LCD_DISP_QSPI_GC9C01)
    res = gc9c01_disp_qspi_init();
#elif defined(LCD_SPI_ILI9341)
    res = ili9341_spi_init();
...
#if defined(LCD_DBI_ILI9488)
    return ili9488_dbi_set_dir(dir, mir_flag);
#elif defined(LCD_DISP_QSPI_GC9C01)
    return gc9c01_disp_qspi_set_dir(dir, mir_flag);
#elif defined(LCD_SPI_ILI9341)
    return ili9341_spi_set_dir(dir, mir_flag);
#elif defined(LCD_SPI_ST7796)
    return st7796_spi_set_dir(dir, mir_flag);
#endif
}
...
{
#if defined(LCD_DBI_ILI9488)
    ili9488_dbi_draw_point(x, y, color);
    return 0;
#elif defined(LCD_DISP_QSPI_GC9C01)
    gc9c01_disp_qspi_draw_point(x, y, color);
    return 0;
#elif defined(LCD_SPI_ILI9341)
    ili9341_spi_draw_point(x, y, color);
    return 0;
#elif defined(LCD_SPI_ST7796)
...
{
#if defined(LCD_DBI_ILI9488)
    ili9488_dbi_draw_area(x1, y1, x2, y2, color);
    return 0;
#elif defined(LCD_DISP_QSPI_GC9C01)
    gc9c01_disp_qspi_draw_area(x1, y1, x2, y2, color);
    return 0;
#elif defined(LCD_SPI_ILI9341)
    ili9341_spi_draw_area(x1, y1, x2, y2, color);
    return 0;
#elif defined(LCD_SPI_ST7796)
...
{
#if defined(LCD_DBI_ILI9488)
    ili9488_dbi_draw_picture_blocking(x1, y1, x2, y2, picture);
    return 0;
#elif defined(LCD_DISP_QSPI_GC9C01)
    gc9c01_disp_qspi_draw_picture_blocking(x1, y1, x2, y2, picture);
    return 0;
#elif defined(LCD_SPI_ILI9341)
    ili9341_spi_draw_picture_blocking(x1, y1, x2, y2, picture);
    return 0;
#elif defined(LCD_SPI_ST7796)
...
int lcd_draw_picture_nonblocking(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, lcd_color_t *picture)
{
    ...
    return 0;
#elif defined(LCD_DISP_QSPI_GC9C01)
    gc9c01_disp_qspi_draw_picture_nonblocking(x1, y1, x2, y2, picture);
    return 0;
#elif defined(LCD_SPI_ILI9341)
...
{
#if defined(LCD_DBI_ILI9488)
    return ili9488_dbi_draw_is_busy();
#elif defined(LCD_DISP_QSPI_GC9C01)
    return gc9c01_disp_qspi_draw_is_busy();
#elif defined(LCD_SPI_ILI9341)
    return ili9341_spi_draw_is_busy();
#elif defined(LCD_SPI_ST7796)
...
int lcd_init(lcd_color_t *screen_buffer)
{
    ...
    return ili9488_dpi_init(screen_buffer);
#elif defined(LCD_DSI_VIDIO_ILI9881C)
    return ili9881c_dsi_vidio_init(screen_buffer);
#endif
}
...
{
#if defined(LCD_DPI_ILI9488)
    return ili9488_dpi_screen_switch(screen_buffer);
#elif defined(LCD_DSI_VIDIO_ILI9881C)
    return ili9881c_dsi_vidio_screen_switch(screen_buffer);
#endif
}
...
{
#if defined(LCD_DPI_ILI9488)
    return ili9488_dpi_get_screen_using();
#elif defined(LCD_DSI_VIDIO_ILI9881C)
    return ili9881c_dsi_vidio_get_screen_using();
#endif
}
