...
#define LMAC154_FRAME_IS_MPP_ACK_REQ(x)             (LMAC154_FRAME_IS_MPP_LONG_FRAME(x) && ((x) & LMAC154_FRAME_MPP_ACK_REQ) == LMAC154_FRAME_MPP_ACK_REQ)
...
#define LMAC154_FRAME_GET_SRC_ADDR_TYPE(x)          (((x) >> LMAC154_FRAME_SRC_ADDR_BIT) & LMAC154_FRAME_ADDR_TYPE_MASK)
#define LMAC154_FRAME_GET_DST_ADDR_TYPE(x)          (((x) >> LMAC154_FRAME_DEST_ADDR_BIT) & LMAC154_FRAME_ADDR_TYPE_MASK)
 ...
 *
 * @param  power_dbm: tx power ranging from LMAC154_TX_POWER_0dBm to LMAC154_TX_POWER_9dBm
 *
 * @return None
 *
*******************************************************************************/
